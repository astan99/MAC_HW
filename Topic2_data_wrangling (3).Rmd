...
#name of data frame, $ select, variable
students$age
...
#head function (name of data frame, n= number of rows you want shown)
head(students, n = 3)
head(students, n=2)
```
...
We will learn some additional concepts and tools in R that will help you to better work with, manage, and clean data for analysis. I will introduce you to some techniques using the dplyr package. Not only is this package extremely useful for data management tasks, but it is also very popular in the R community and will be a very valuable tool in your arsenal. Let's get started!

Next, let's get started in dplyr! This package is part of a larger family of packages that are known as the tidyverse. It's very helpful for working with data and hopefully you'll agree!
...
#First things first: the pipe symbol, or %>%  or |>
